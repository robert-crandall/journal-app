...
apiRoutes.post('/auth/register', validator('json', schemas.userRegisterSchema), authController.register);
apiRoutes.post('/auth/login', validator('json', schemas.userLoginSchema), authController.login);
...
apiRoutes.post('/quests', authMiddleware, validator('json', schemas.questSchema), questController.createQuest);
apiRoutes.put('/quests/:id', authMiddleware, validator('json', schemas.questSchema), questController.updateQuest);
...
// Quest milestones
apiRoutes.post('/quest-milestones', authMiddleware, validator('json', schemas.questMilestoneSchema), questController.createQuestMilestone);
...
apiRoutes.post('/journal', authMiddleware, validator('json', schemas.journalEntrySchema), journalController.createJournalEntry);
apiRoutes.put('/journal/:id', authMiddleware, validator('json', schemas.journalEntrySchema), journalController.updateJournalEntry);
apiRoutes.delete('/journal/:id', authMiddleware, journalController.deleteJournalEntry);
apiRoutes.post('/journal/analyze', authMiddleware, validator('json', schemas.journalAnalysisSchema), journalController.analyzeJournalEntry);
...
apiRoutes.post('/tasks', authMiddleware, validator('json', schemas.taskSchema), taskController.createTask);
apiRoutes.put('/tasks/:id', authMiddleware, validator('json', schemas.taskSchema), taskController.updateTask);
...
apiRoutes.post('/character-stats', authMiddleware, validator('json', schemas.characterStatSchema), characterStatController.createCharacterStat);
apiRoutes.put('/character-stats/:id', authMiddleware, validator('json', schemas.characterStatSchema), characterStatController.updateCharacterStat);
...
apiRoutes.post('/experiments', authMiddleware, validator('json', schemas.experimentSchema), experimentController.createExperiment);
apiRoutes.put('/experiments/:id', authMiddleware, validator('json', schemas.experimentSchema), experimentController.updateExperiment);
...
apiRoutes.post('/conversations', authMiddleware, validator('json', schemas.conversationSchema), conversationController.createConversation);
apiRoutes.put('/conversations/:id', authMiddleware, validator('json', schemas.conversationSchema), conversationController.updateConversation);
apiRoutes.delete('/conversations/:id', authMiddleware, conversationController.deleteConversation);
apiRoutes.post('/conversations/message', authMiddleware, validator('json', schemas.messageSchema), conversationController.sendMessage);

// User context for AI
apiRoutes.get('/user-context', authMiddleware, conversationController.getUserContext);
apiRoutes.post('/user-context', authMiddleware, validator('json', schemas.userContextSchema), conversationController.setUserContext);
