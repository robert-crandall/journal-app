...
test.describe('Stats Management', () => {
  ...
  test('should display multiple stats with correct progress', async ({ page }) => {
    ...
    const stats = [
      { name: 'Fitness', description: 'Physical health tracking', activity: 'Workout session', xp: 15 },
      { name: 'Learning', description: 'Educational progress', activity: 'Complete a course', xp: 25 },
      { name: 'Creativity', description: 'Creative projects', activity: 'Create something new', xp: 20 }
    ];
