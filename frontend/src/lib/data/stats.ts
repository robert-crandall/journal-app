...
export const STAT_LIBRARY: StatDefinition[] = [
	...
	},
	{
		...
		category: 'body',
		description:
			'Your overall life force: sleep, mood, stress regulation, libido, sense of aliveness',
		icon: 'heart-pulse'
	},
	...
	// CONNECTION
	{
		...
		category: 'connection',
		description:
			'Confidence, emotional presence, social engagement, and ability to influence others',
		icon: 'megaphone'
	},
	{
		name: 'Intimacy',
		category: 'connection',
		description:
			'Capacity for closeness, emotional openness, and authentic connection (with self or others)',
		icon: 'handshake'
	},
	{
		name: 'Courage',
	...
	},
	{
		...
		category: 'connection',
		description:
			'Practical skill-building: making, fixing, building — external proof of internal mastery',
		icon: 'hammer'
	},
