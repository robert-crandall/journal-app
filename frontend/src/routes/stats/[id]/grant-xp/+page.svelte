						...
						<div class="mb-6 flex items-center gap-4">
							...
							<div>
								...
								<p class="text-base-content/60">
									Award yourself experience points for completed activities
								</p>
							</div>
						</div>
