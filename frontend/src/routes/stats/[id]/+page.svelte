						...
						{:else}
							<div class="py-8 text-center">
								...
								<p class="text-base-content/60">
									No XP history yet. Start earning XP to see your progress!
								</p>
							</div>
						{/if}
					</div>
					...
					<div class="card-body">
						...
						<div class="space-y-2">
							{#each Array(Math.min(stat.currentLevel + 3, 10)) as _, i}
								...
								<div
									class="flex items-center gap-3 rounded-lg p-2 {isCurrentLevel
										? 'bg-primary/10'
										: ''}"
								>
									<div
...
{#if showDeleteModal}
	<div class="modal modal-open">
		<div class="modal-box">
			...
			<p class="py-4">
				Are you sure you want to delete "<strong>{stat?.name}</strong>"? This action cannot be
				undone and will permanently remove all XP history.
			</p>
