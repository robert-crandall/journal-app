<script lang="ts">
  ...
  async function handleSubmit(event: Event) {
    ...
    try {
      ...
      // Redirect to the new plan's details page
      goto(`/projects/${newPlan.id}`);
    } catch (err) {
...
<svelte:head>
  ...
  <meta name="description" content="Create a new plan to organize your projects, adventures, and themes" />
</svelte:head>
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-base-content/70">Organize your projects, adventures, and themes</p>
          </div>
        </div>
      </div>
    </div>
