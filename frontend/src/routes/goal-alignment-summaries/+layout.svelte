...
<PageContainer>
  ...
  {:else if $page.route.id === '/goal-alignment-summaries/generate'}
    <AppHeader icon={TargetIcon} title="Generate Goal Alignment Analysis" subtitle="Analyze how well your journal entries align with your active goals" buttons={[backButton]} />
