<script lang="ts">
  ...
  import { CalendarIcon, SparklesIcon, AlertCircleIcon, InfoIcon } from 'lucide-svelte';
...
<div class="alert alert-info mb-6">
  ...
  <div>
    ...
    <p class="text-sm">
      This feature analyzes your journal entries against your active goals, providing insights into: • Which goals you're making progress on • Goals that need
      more attention • Specific evidence from your journals • Actionable next steps
    </p>
  </div>
</div>
...
<div class="mt-6 text-center">
  <p class="text-base-content/60 text-sm">Analysis typically takes 10-30 seconds to complete and will include detailed insights about your goal alignment.</p>
</div>
