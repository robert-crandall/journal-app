    ...
    <div class="mb-8">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-gradient text-3xl font-bold">Goal Alignment Analysis</h1>
            <p class="text-base-content/70">Track how well your activities align with your goals over time</p>
          </div>
        </div>
