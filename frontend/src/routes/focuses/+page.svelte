	...
	<div class="mx-auto max-w-7xl px-6 py-8">
			...
			<div class="mb-6 flex items-center justify-between">
				...
				<div class="flex items-center space-x-3">
					<button
						...
						class="inline-flex items-center rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50"
					>
		...
		{:else if focuses.length === 0}
			<div class="py-16 text-center">
				<div class="mx-auto max-w-md rounded-lg border border-neutral-200 bg-white p-12">
					<div
		...
		{:else}
			<!-- Weekly Schedule -->
			{#if weeklyFocuses > 0}
				<div class="mb-8 rounded-lg border border-neutral-200 bg-white p-6">
			...
			<div class="space-y-4">
				{#each focuses as focus}
					<div
						class="rounded-lg border border-neutral-200 bg-white p-6 transition-shadow hover:shadow-sm"
					>
...
{#if showFocusLibrary}
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
		<div class="max-h-[85vh] w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-2xl">
			<!-- Modal Header -->
			<div class="border-b border-neutral-200 bg-neutral-50 px-6 py-4">
				<div class="flex items-center justify-between">
					<div class="flex items-center space-x-3">
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
					{#each EXTENDED_FOCUS_LIBRARY as template}
						<button
							...
							class="group rounded-lg border border-neutral-200 bg-white p-4 text-left transition-all hover:border-blue-300 hover:bg-blue-50"
						>
							<div class="mb-3 flex items-center space-x-3">
								<div
