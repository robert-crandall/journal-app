...
<svelte:head>
  <title>New Measurement - Gamified Life</title>
  <meta name="description" content="Record a new body measurement to track your fitness progress" />
</svelte:head>
  ...
  <div class="from-primary/10 to-secondary/10 border-primary/20 border-b bg-gradient-to-br">
    <div class="mx-auto max-w-4xl px-4 py-8">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-primary text-3xl font-bold">New Measurement</h1>
          <p class="text-base-content/70">Record your body measurements and track your progress</p>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="space-y-3 text-sm">
                ...
                <div class="bg-base-200 rounded-lg p-3">
                  ...
                  <ul class="text-xs space-y-1 text-base-content/60">
                    ...
                    <li>• Height (from profile)</li>
                    <li>• Sex (from profile)</li>
