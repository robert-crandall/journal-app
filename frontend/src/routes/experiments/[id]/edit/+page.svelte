...
<div class="container mx-auto px-4 py-8 max-w-4xl">
  ...
  {:else if error}
    <!-- Error State -->
    <div class="rounded-lg border border-red-200 bg-red-50 p-6 mb-6">
      <p class="text-red-800">{error}</p>
      <button onclick={loadExperiment} class="mt-2 text-red-600 underline hover:text-red-700">
        Try again
      </button>
    </div>
  {/if}
    ...
    <div class="space-y-8">
      ...
      <div class="card bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20 border">
        <div class="card-body">
          ...
          <p class="text-gray-600">Modify your experiment details and manage daily tasks.</p>
        </div>
      </div>
      ...
      <div class="card bg-base-100 border-base-300 border">
        <div class="card-body">
          <h2 class="text-2xl font-bold text-gray-900 mb-6">Experiment Details</h2>
