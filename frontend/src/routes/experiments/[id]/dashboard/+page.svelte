...
<div class="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1">
              <div class="flex items-center gap-3 mb-2">
                <h1 class="text-3xl font-bold text-gray-900">{dashboard.experiment.title}</h1>
              ...
              {#if dashboard.experiment.description}
                <p class="text-gray-600 text-lg mb-4">{dashboard.experiment.description}</p>
              {/if}
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="card bg-base-100 border-base-300 border">
          <div class="card-body text-center">
            ...
            <div class="text-xs text-gray-500">out of {dashboard.stats.totalDays}</div>
          </div>
        </div>
        ...
        <div class="card bg-base-100 border-base-300 border">
          <div class="card-body text-center">
            ...
            <div class="text-xs text-gray-500">out of {dashboard.stats.totalTaskInstances}</div>
          </div>
        </div>
        ...
        <div class="card bg-base-100 border-base-300 border">
          <div class="card-body text-center">
            ...
            <div class="text-xs text-gray-500">{dashboard.xpBreakdown.fromTasks} from tasks, {dashboard.xpBreakdown.fromJournals} from journals</div>
          </div>
        </div>
        ...
        <div class="card bg-base-100 border-base-300 border">
          <div class="card-body text-center">
            ...
            <div class="text-xs text-gray-500">during experiment</div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="card-body">
              ...
              <div class="space-y-6">
                {#each dashboard.tasks as task}
                  <div class="space-y-3">
                    <div class="flex items-start justify-between">
                      <div class="flex-1">
                        <h3 class="font-semibold text-gray-900">{task.description}</h3>
            ...
            {:else}
              <div class="text-center py-8">
                ...
                <p class="text-gray-600">Add some daily tasks to track progress.</p>
              </div>
            {/if}
          </div>
        </div>
        ...
        <div class="card bg-base-100 border-base-300 border">
          <div class="card-body">
                  ...
                  <div class="p-4 rounded-lg border border-gray-200 bg-gray-50">
                    <div class="flex items-start justify-between">
                      <div class="flex-1">
                        ...
                        {#if entry.synopsis}
                          <p class="text-sm text-gray-600 mb-2 line-clamp-2">{entry.synopsis}</p>
                        {/if}
                        <div class="text-xs text-gray-500">
            ...
            {:else}
              <div class="text-center py-8">
                <Book class="mx-auto h-12 w-12 text-gray-300 mb-4" />
                <h3 class="text-lg font-medium text-gray-900 mb-2">No journal entries</h3>
                <p class="text-gray-600 mb-4">Write about your experiment experience to track insights and progress.</p>
        ...
        <div class="card-body">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
              ...
              <div class="text-sm text-gray-600 mb-1">From Tasks</div>
              <div class="text-xs text-gray-500">
            ...
            <div class="text-center">
              ...
              <div class="text-sm text-gray-600 mb-1">From Journals</div>
              <div class="text-xs text-gray-500">
            ...
            <div class="text-center">
              ...
              <div class="text-sm text-gray-600 mb-1">Total XP</div>
              <div class="text-xs text-gray-500">
  ...
  {:else}
    ...
    <div class="text-center py-12">
      ...
      <p class="text-gray-600 mb-6">The experiment dashboard you're looking for doesn't exist or you don't have access to it.</p>
