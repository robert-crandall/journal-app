...
test.describe('Content Management', () => {
  ...
  test.describe('Create Content', () => {
    ...
    test('should successfully create a new post', async ({ page }) => {
      ...
      await expect(page.locator('.alert-success:has-text("Post created successfully")')).toBeVisible();
  ...
  test.describe('Update Content', () => {
    ...
    test('should show update form when clicking update button', async ({ page }) => {
      ...
      await expect(page.locator('textarea[name="content"]')).toHaveValue('Original content for updating tests.');
    ...
    test('should successfully update a post', async ({ page }) => {
      ...
      // Should show success message
      await expect(page.locator('.alert-success:has-text("Post updated successfully")')).toBeVisible();
