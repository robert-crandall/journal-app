...
test.describe('Authentication Flow', () => {
  ...
  test('should show error for duplicate email registration', async ({ page }) => {
    ...
    await expect(page.locator('.alert-error')).toContainText('An account with this email already exists');
  });
  ...
  test('should redirect already logged in users from auth pages and home page', async ({ page }) => {
    // Register and login a user
    const redirectUser = {
