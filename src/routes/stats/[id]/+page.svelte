				...
				<div class="flex flex-col justify-center">
					...
					<progress
						...
						value={calculateXpProgress(
							data.stat.currentXp,
							data.stat.totalXpForCurrentLevel,
							data.stat.totalXpForNextLevel
						)}
						max="100"
					></progress>
						...
						<form method="POST" action="?/addActivity" use:enhance>
							...
							<div class="form-control mb-4">
								...
								<div class="label">
									<span class="label-text-alt"
										>How much XP this activity should typically award (1-100)</span
									>
								</div>
							</div>
							<div class="flex gap-2">
								...
								<button
									...
									onclick={() => (showAddActivityForm = false)}
								>
									Cancel
								</button>
							</div>
				...
				{#if data.xpHistory.length === 0}
					<div class="py-8 text-center">
						...
						<p class="text-base-content/50 mt-2 text-sm">
							Complete tasks or journal entries to start earning XP
						</p>
					</div>
				{:else}
