						...
						<div class="card-body">
							...
							<form method="POST" action="?/create" use:enhance class="space-y-6">
								...
								<div class="form-control">
									...
									<div class="label">
										<span class="label-text-alt"
											>Choose a meaningful name for tracking your growth</span
										>
									</div>
								</div>
								...
								<div class="form-control">
									...
									<div class="label">
										<span class="label-text-alt"
											>Describe what this stat represents in your life</span
										>
									</div>
								</div>
								...
								<div class="form-control">
									<input
										...
										value={form && 'exampleActivity' in form
											? (form.exampleActivity as string)
											: ''}
									/>
									<div class="label">
										<span class="label-text-alt"
											>An example activity that would earn XP for this stat</span
										>
									</div>
								</div>
								...
								<div class="form-control">
									...
									<div class="label">
										<span class="label-text-alt"
											>How much XP this example activity should award (1-100)</span
										>
									</div>
								</div>
		...
		{#if data.stats.length === 0}
			<div class="py-12 text-center">
				...
				<p class="text-base-content/50 mb-4">
					Create your first stat to start tracking your personal growth
				</p>
				<button class="btn btn-primary" onclick={() => (showCreateForm = true)}>
					<Plus size={20} />
							...
							<div class="mb-4">
								...
								<progress
									...
									value={calculateXpProgress(
										stat.currentXp,
										stat.totalXpForCurrentLevel,
										stat.totalXpForNextLevel
									)}
									max="100"
								></progress>
							</div>
									...
									<div class="flex flex-wrap gap-1">
										...
										{#if stat.activities.length > 3}
											<span class="badge badge-ghost badge-sm"
												>+{stat.activities.length - 3} more</span
											>
										{/if}
									</div>
								</div>
								...
								<div class="mt-4 border-t pt-4">
									<form method="POST" action="?/update" use:enhance>
										...
										<div class="form-control mb-4">
											...
											<div class="label">
												<span class="label-text-alt"
													>The name of your stat (e.g., "Fitness", "Learning")</span
												>
											</div>
										</div>
										<div class="form-control mb-4">
											...
											<div class="label">
												<span class="label-text-alt"
													>Help clarify what activities contribute to this stat</span
												>
											</div>
										</div>
										<div class="mb-4">
