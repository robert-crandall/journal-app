...
<div class="bg-base-200 min-h-screen">
		...
		<div class="grid lg:grid-cols-3 gap-8 mb-8">
			...
			<div class="lg:col-span-2">
				<div class="card bg-base-100 shadow-lg">
					<div class="card-body">
						<h2 class="card-title text-2xl mb-6">Create New Stat</h2>
	...
	{#if data.stats.length === 0}
		<div class="text-center py-12">
			<BarChart3 size={48} class="mx-auto text-base-content/50 mb-4" />
			<h3 class="text-xl font-semibold text-base-content/70 mb-2">No stats yet</h3>
					...
					<div class="card-body">
						<div class="flex justify-between items-start mb-4">
							<div class="flex-1">
								...
								{#if stat.description}
									<p class="text-base-content/70 text-sm mt-1">{stat.description}</p>
								{/if}
							</div>
							<div class="dropdown dropdown-end">
								...
								<ul class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
									<li>
										<button onclick={() => editingStat = stat.id}>
											<Edit size={16} />
											Edit
										</button>
									</li>
						...
						<div class="mb-4">
							<div class="flex items-center gap-2 mb-2">
								...
								{#if stat.currentLevelTitle}
									<span class="text-sm font-medium text-base-content/80">{stat.currentLevelTitle}</span>
								{/if}
							</div>
						</div>
						...
						{#if stat.activities.length > 0}
							<div class="mb-4">
								<h4 class="font-medium text-sm text-base-content/80 mb-2">Activities:</h4>
							...
							<div class="border-t pt-4 mt-4">
								<form method="POST" action="?/update" use:enhance>
									...
									<div class="flex gap-2">
										...
										<button type="button" class="btn btn-ghost btn-sm" onclick={() => editingStat = null}>
											Cancel
										</button>
									</div>
								</form>
							...
							<div class="border-t pt-4 mt-4">
								<form method="POST" action="?/awardXp" use:enhance>
									...
									<div class="flex gap-2">
										...
										<button type="button" class="btn btn-ghost btn-sm" onclick={() => awardingXpStat = null}>
											Cancel
										</button>
									</div>
								</form>
