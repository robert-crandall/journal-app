...
<div class="bg-base-200 min-h-screen">
  <div class="container mx-auto p-6">
    ...
    <div class="mb-8">
      ...
      <p class="text-base-content/70">Define your in-game persona to personalize your journey and AI-generated tasks.</p>
    </div>
          ...
          <div class="card-body">
            ...
            >
              ...
              <div class="form-control">
                ...
                />
                <div class="label">
                  <span class="label-text-alt"> Choose from suggestions or create your own unique class </span>
                </div>
              </div>
              ...
              <div class="form-control">
                ...
                <div class="flex flex-wrap gap-2">
                  {#each suggestedClasses as suggestedClass (suggestedClass)}
                    <button type="button" class="btn btn-sm btn-outline" onclick={() => (characterClass = suggestedClass)}>
                      {suggestedClass}
                    </button>
                  {/each}
                </div>
              ...
              <div class="form-control">
                ...
                ></textarea>
                <div class="label">
                  <span class="label-text-alt"> This will help the AI understand you better and generate personalized tasks </span>
                </div>
              </div>
              ...
              <div class="form-control">
                ...
                />
                <div class="label">
                  <span class="label-text-alt"> A guiding principle that defines your aspirations </span>
                </div>
              </div>
              ...
              <div class="form-control">
                ...
                ></textarea>
                <div class="label">
                  <span class="label-text-alt"> Define your high-level goals for personal growth. Supports markdown formatting. </span>
                </div>
              </div>
      ...
      <div class="space-y-6">
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            ...
            <div class="space-y-4">
              <div>
                <h4 class="text-base-content/70 text-sm font-semibold tracking-wide uppercase">Class</h4>
              ...
              {#if motto}
                <div>
                  <h4 class="text-base-content/70 text-sm font-semibold tracking-wide uppercase">Motto</h4>
          ...
          <div class="card-body">
            ...
            <div class="space-y-3 text-sm">
              <div class="flex gap-3">
                <svg class="text-primary mt-0.5 h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
