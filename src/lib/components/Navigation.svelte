...
<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="flex-none gap-2">
    ...
    <div class="dropdown dropdown-end">
      <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar" data-testid="user-avatar-button">
        <div class="bg-primary text-primary-content flex w-10 items-center justify-center rounded-full">
          {user.name.charAt(0).toUpperCase()}
        </div>
      </div>
      <ul class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow" data-testid="user-dropdown-menu">
